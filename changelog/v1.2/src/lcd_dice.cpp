...
// Teilt die globale SPI-Instanz mit der SD-Karte (gleiche Pins SCK/MOSI).
// SPI.begin() wird in microsdcard_init() aufgerufen – hier NICHT nochmal!
static Adafruit_GC9A01A tft(&SPI, LCD_TFT_DC, LCD_TFT_CS, LCD_TFT_RST);
...
void lcdDiceInit()
{
  // SPI.begin() wird in microsdcard_init() aufgerufen – hier nicht nochmal aufrufen!
